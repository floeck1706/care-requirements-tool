...
(:~
 ...
 : @param $condition-subject Subjekt der Bedingung (Ereignis)
 : @param $condition-actor Akteur der Bedingung (nicht verwendet)
...
declare %restxq:path("restancil/save/{$pkg-id}/{$pkg-version-id}/{$ref-id}")
        ...
        %restxq:query-param("actor","{$condition-actor}","")
        %restxq:query-param("subject","{$condition-subject}","")
